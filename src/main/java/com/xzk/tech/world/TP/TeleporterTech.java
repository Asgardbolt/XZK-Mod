...
public class TeleporterTech implements ITeleporter {
    private BlockPos pos;

    public TeleporterTech(BlockPos pos) {
        this.pos = pos;
    }
    ...
    public Entity placeEntity(Entity entity, ServerWorld currentWorld, ServerWorld destWorld, float yaw, Function<Boolean, Entity> repositionEntity) {
        ...
        destWorld.setBlock(calculateLowestBedrockPos(destWorld, pos), BlockRegistry.DeepPortalToOverworld.get().defaultBlockState(), 4);
    ...
    BlockPos calculateLowestBedrockPos(ServerWorld world, BlockPos pos){
        for(int i = 250; i <= 255; i++){
            ...
            if(block == Blocks.BEDROCK || block == BlockRegistry.DeepPortalToOverworld.get()) return new BlockPos(pos.getX(), i, pos.getZ());
        }
