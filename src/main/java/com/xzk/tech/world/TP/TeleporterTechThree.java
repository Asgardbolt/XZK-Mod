...
public class TeleporterTechThree implements ITeleporter {
    private BlockPos pos;

    public TeleporterTechThree(BlockPos pos) {
        this.pos = pos;
    }
    ...
    public Entity placeEntity(Entity entity, ServerWorld currentWorld, ServerWorld destWorld, float yaw, Function<Boolean, Entity> repositionEntity) {
        ...
        destWorld.setBlock(calculateLowestBedrockPos(destWorld, pos), BlockRegistry.VeryDeepPortalToVeryDeep.get().defaultBlockState(), 4);
    ...
    BlockPos calculateLowestBedrockPos(ServerWorld world, BlockPos pos){
        for(int i = 5; i >= 0; i--){
            ...
            if(block == Blocks.BEDROCK || block == BlockRegistry.VeryDeepPortalToVeryDeep.get()) return new BlockPos(pos.getX(), i, pos.getZ());
        }
