...
public class DamagedBasicBuildingTools extends Item {
    public DamagedBasicBuildingTools() {
    ...
    public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
        ...
        ItemStack itemstack1 = new ItemStack(ItemRegistry.BrokenBasicBuildingTools.get());
